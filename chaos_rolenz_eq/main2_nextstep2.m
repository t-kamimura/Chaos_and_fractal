...
% load("initial value2.mat")
% load("initial value3.mat")
% load("initial value4.mat")
load("initial value5.mat")
...
if saveflag == true
%     videoobj = VideoWriter([date,'movie3.mp4'],'MPEG-4');
%     videoobj = VideoWriter([date,'movie4.mp4'],'MPEG-4');
%     videoobj = VideoWriter([date,'movie5.mp4'],'MPEG-4');
    videoobj = VideoWriter([date,'movie6.mp4'],'MPEG-4');
    fprintf('video generating...')
    open(videoobj);
    writeVideo(videoobj, F);
    close(videoobj);
    fprintf('complete!\n')
%     save('initial value3','q')
%     save('initial value4','q')
%     save('initial value5','q')
    save('initial value6','q')
end
